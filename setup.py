...
setup(
    name='''ckanext-openbudgetsin_theme''',
    ...
    description='''Theme extensi''',
    long_description=long_description,

    # The project's main homepage.
    url='https://github.com/akshay2905/ckanext-openbudgetsin_theme',
    ...
    keywords='''CKAN Ckan Theme Open Budget Data''',
